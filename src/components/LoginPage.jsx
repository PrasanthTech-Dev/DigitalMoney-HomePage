  ...
  return (
    <div className="w-full min-h-screen flex bg-white" style={{ fontFamily: "'Poppins', 'Segoe UI', sans-serif" }}>
      <BrandPanel
        ...
        headline="Log in to manage your money in one place."
        subtext="Track transfers, pay bills, and shop securely — all from a single Money account."
      />
      ...
      <div className="w-full md:w-1/2 flex flex-col justify-center px-6 sm:px-12 md:px-16 py-12">
        ...
        <div className="w-full max-w-sm mx-auto">
          ...
          <form
            ...
            onSubmit={(e) => {
              ...
              if (email) {
                ...
                localStorage.setItem("user", JSON.stringify({ email, name: capitalized }));
                navigate("/");
              }
            }}
          >
            ...
            <Field
              ...
              rightSlot={
                ...
                >
                  {showPassword ? (
                    <EyeOff size={18} color={C.gray} />
                  ) : (
                    <Eye size={18} color={C.gray} />
                  )}
                </button>
              }
            />
            ...
            <div className="flex items-center justify-between">
              ...
              <Link to="/forgot-password" className="text-sm font-semibold" style={{ color: C.purple }}>
                Forgot password?
              </Link>
            </div>
          ...
          <p className="text-sm text-center mt-8" style={{ color: C.gray }}>
            ...
            <Link to="/signup" className="font-semibold" style={{ color: C.purple }}>
              Sign up
            </Link>
          </p>
        </div>
